###############################################################################
# run_sensitivity_parallel_w09_optimized.R
...
source("ValoresIniciais_Lambda_it_T100_w09.R")
...
source("ValoresIniciais_Lambda_it_T23_w09.R")
...
run_scenario_worker <- function(idx, config_df, 
                                ...
                                niter = 7000, nchains = 2, nburnin = 2000) {
...
niter_run <- 6000   # troque para 50000 quando quiser rodar full
nchains_run <- 2
nburnin_run <- 1000
