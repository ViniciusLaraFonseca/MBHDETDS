...
gamma_true[1, ] <- c(rep(0.10, 12), rep(0.05, 11)) # Penalidade Base (Cluster 1)
gamma_true[2, ] <- c(rep(0.10, 12), rep(0.05, 11)) # Adicional p/ Cluster 2
gamma_true[3, ] <- c(rep(0.10, 12), rep(0.05, 11)) # Adicional p/ Cluster 3
gamma_true[4, ] <- c(rep(0.15, 12), rep(0.10, 11)) # Adicional p/ Cluster 4
...
constants_nimble <- list(
  ...
  mu_beta   = rep(0, p),
  a_unif    = c(rep(0.05, 12), rep(0.00, 11)), 
  b_unif    = c(rep(0.15, 12), rep(0.1, 11)),  
  delta     = 0.05, 
  a0        = a0_true, 
  b0        = b0_true, 
  w         = w_true
